...
public class DishController {
    ...
    @PutMapping
    @ApiOperation("修改菜品")
    @CacheEvict(cacheNames = {"dishCache", "setmealCache","categoryCache","dishCache"}, allEntries = true)
    ...
    @ApiOperation("修改菜品状态")
    @CacheEvict(value = {"dishCache", "setmealCache","categoryCache","dishCache"}, allEntries = true)
